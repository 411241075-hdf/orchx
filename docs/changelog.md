...
* **P1.5**: Notification plugins (Slack, Discord, Webhook). Auto-fan-out через `_CompoundNotifier` при множественных notifiers. События: run_started, phase_*, replan_*, pr_opened, cost_alert, ci_failed, changes_requested, approved_and_green, run_finished, auto_fixup_planned.
